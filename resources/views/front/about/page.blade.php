...
@section('content')
    ...
    <x-page-photo-banner img-large="/images/banners/homepage_banner.jpg" img-small="/images/banners/homepage_banner_mobile.jpg" :title="trans('about.banner.title')" :text="trans('about.banner.text')"></x-page-photo-banner>
