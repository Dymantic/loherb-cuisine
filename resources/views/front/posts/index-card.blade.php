<div class="flex flex-col justify-between mb-8 w-9/10 md:w-64 max-w-full bg-pinky-grey mx-auto">
    <div>
        ...
        <div class="p-4">
            <p class="type-h1 text-purple">{{ $post['title'] }}</p>
            <p class="type-b2 text-purple-soft">{{ $post['publish_date_string'] }}</p>
