<section id="alcohol" class="bg-pinky-grey max-w-5xl reg-section-space flex flex-col items-center mx-auto my-12">
    <p class="type-h1 text-navy mb-8">{{ trans($menu['alcohol']['title']) }}</p>
