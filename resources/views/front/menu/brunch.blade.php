<section id="brunch" class="bg-pinky-grey max-w-5xl reg-section-space flex flex-col items-center mx-auto my-12">
    <p class="type-a1 text-navy mb-8 uppercase">{{ trans('menu.brunch.title') }}</p>
